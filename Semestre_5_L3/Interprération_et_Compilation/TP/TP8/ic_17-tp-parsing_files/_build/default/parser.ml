...
let rec _menhir_goto_block : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.Syntax.block) -> 'ttv_return =
...
# 108 "parser.ml"
        ...
        | Lsc ->
            ...
            let _menhir_env = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, _menhir_s, _startpos__1_), (e : (Ast.Syntax.expr))) = _menhir_stack in
