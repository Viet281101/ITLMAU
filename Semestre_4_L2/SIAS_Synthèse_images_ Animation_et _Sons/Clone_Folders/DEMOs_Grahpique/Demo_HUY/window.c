...
static GL4DHanime _animations[] = {
  { 5000, exemple_d_animation_00, NULL, NULL },
  { 2000, exemple_d_animation_00, spectre_3d, exemple_de_transition_01 },
  { 5000, spectre_3d, NULL, NULL },
  { 1000, spectre_3d, seq_voro, exemple_de_transition_01 },
  { 10000, seq_voro, NULL, NULL },
  { 2000, exemple_d_animation_00, spectre_3d, exemple_de_transition_01 },
  { 6000, spectre_3d, NULL, NULL },
  { 8000, animation_mendel, NULL, NULL},
  { 8000, animation_julia, NULL, NULL},
  {10000, credit_fin, NULL, NULL},
...
int main(int argc, char ** argv) {
  if(!gl4duwCreateWindow(argc, argv, "GL4Dummies Demo Graphique -- HUY", 
  ...
  ahInitAudio("TellMeThatICant.mp3");
  gl4duwMainLoop();
  return 0;
}
