...
void init(void) {
  ...
  _tore = gl4dgGenTorusf(50, 30, 0.2f);
...
void draw(void) {
  ...
  const GLfloat rouge[] = {1.0f, 0.0f, 0.0f, 1.0f}, vert[] = {0.0f, 1.0f, 0.0f, 1.0f};
...
//   gl4duBindMatrix("view");
  ...
  glUniform4fv(couleur_loc, 1, rouge);
  ...
  gl4duSendMatrices();
  /* demander le dessin d'un objet GL4D */
  glUniform4fv(couleur_loc, 1, vert);
  gl4dgDraw(_tore);
