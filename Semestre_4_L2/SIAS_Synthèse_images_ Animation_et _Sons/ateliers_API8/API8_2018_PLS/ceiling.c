...
void
ceiling_init(ceiling_t* c, GLuint pgm_id, GLuint pgm_id_rendu)
{
  c->pgm_id_rendu = pgm_id_rendu;
  c->pgm_id = pgm_id;
  c->mesh_id = gl4dgGenQuadf();
  c->fbo_id = 0;
  ...
  gl4duPushMatrix();
  {
      ...
      gl4duPushMatrix();
      {
          ...
          gl4duPushMatrix();
          {
              ...
              gl4duTranslatef(20, 6, -200);
              gl4duScalef(200, 200, 10);
...
ceiling_draw(ceiling_t* c)
{
  ...
  gl4duPushMatrix();
  {
    gl4duTranslatef(0, 8, -10);
    gl4duRotatef(-90, 1, 0, 0);
    gl4duScalef(300, 300, 0);
    gl4duSendMatrices();
  } gl4duPopMatrix();
  gl4duPopMatrix();
