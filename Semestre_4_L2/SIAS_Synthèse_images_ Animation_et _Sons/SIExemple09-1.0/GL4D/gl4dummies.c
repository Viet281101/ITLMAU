...
static int kmpSearch(char * p, char * t);
 ...
 */
int GL4DAPIENTRY gl4dExtensionSupported(char * extension) {
 ...
 *
 * \un pointeur vers le texte recopié en mémoire. La mémoire
...
/*!\brief Retourne un nombre pseudo-aleatoire dans l'intervalle [0,
 * 1[. Ici la distribution est Gaussienne.
 *
