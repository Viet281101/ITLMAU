...
static GL4DHanime _animations[] = {
  { 15000,animation_sierpinski, NULL, NULL },
  { 10000,animation_mendel, NULL, NULL },
  { 5000,animation_barnsley, NULL, NULL },
  { 16000,animation_julia_zoom, NULL, NULL },
  { 8000,animation_pythagore, NULL, NULL },
  { 20000,animation_julia, NULL, NULL },
...
int main(int argc, char ** argv) {
  if(!gl4duwCreateWindow(argc, argv, "KARUNAKARAN Nithushan: Fractales",
  ...
  /* Plug Walk
    Credits goes to the author: Rich The Kid
*/
