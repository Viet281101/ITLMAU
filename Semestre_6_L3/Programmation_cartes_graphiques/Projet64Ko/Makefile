...
SOURCES = animations.c audioHelper.c spectre.c window.c credit.c
MSVCSRC = $(patsubst %,<ClCompile Include=\"%\\\" \\/>,$(SOURCES))
OBJ = $(SOURCES:.c=.o)
DOXYFILE = documentation/Doxyfile
VSCFILES = $(PROGNAME).vcxproj $(PROGNAME).sln
EXTRAFILES = COPYING README.md $(wildcard shaders/*.?s assets/images/* assets/images/pentagram/*.png assets/images/explo/*.png assets/images/mob/*.png assets/images/runes/*.png) $(VSCFILES) assets/audio/TheLoomingBattle.ogg assets/font/alagard.ttf
