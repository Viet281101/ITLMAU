...
//// Définr une fonction heuristique pour la variante classique du jeu Breakthrough
int heuristique(bt_t &B, bool white_turn){
	int score = 0;
	int nb_lignes = B.nbl;
	int nb_colonnes = B.nbc;
	int i, j;
